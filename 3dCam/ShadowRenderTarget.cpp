...
{
	// Ñíà÷àëà ìû ñîçäàåì òåêñòóðó â êîòîðóþ áóäåì âûâîäèòü shadow map

	// ñîçäàåì òåêñòóðó ðàçìåðîì SHADOWMAP_WIDTH õ SHADOWMAP_HEIGHT
	// äàííàÿ òåêñòóðà áóäåò èñïîëüçîâàòüñÿ êàê render target (óñòàíîâèëè
	// ôëàã - D3D11_BIND_RENDER_TARGET)
	...
	// ñîçäàåì shader resource view c ðàíåå ñîçäàííîé òåêñòóðû
	...
	// Ñîçäàåì Depth Stencil View

	// Ñîçäàåì òåêñòóðó ãëóáèíû
	...
	// Çàäàåì âüþïîðò ïî ðàçìåðó íàøåé òåêñòóðû
...
{
	// Áèíäèì RTV è áóôåð ãëóáèíû ê êîíâååðó
