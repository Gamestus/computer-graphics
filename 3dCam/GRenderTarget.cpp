...
GRenderTarget::GRenderTarget(Game* game)
{
	m_RTTexture = nullptr;
	m_RTV = nullptr;
	m_SRV = nullptr;
...
bool GRenderTarget::Init()
{

	D3D11_TEXTURE2D_DESC textureDesc;
	ZeroMemory(&textureDesc, sizeof(textureDesc));
	textureDesc.Width = pGame->Display->ClientWidth;
	textureDesc.Height = pGame->Display->ClientHeight;
	...
	depthBufferDesc.Width = pGame->Display->ClientWidth;
	depthBufferDesc.Height = pGame->Display->ClientHeight;
	...
	m_viewport.Width = (float)pGame->Display->ClientWidth;
	m_viewport.Height = (float)pGame->Display->ClientHeight;
...
void GRenderTarget::SetRenderTarget()
{
...
void GRenderTarget::ClearRenderTarget(float red, float green, float blue, float alpha)
{
...
ID3D11ShaderResourceView* GRenderTarget::GetShaderResourceView()
{
	return m_SRV;
}